...
class Ingredient(Base):
    ...
    name = Column(String)
    description = Column(String)
    category_id = Column(Integer, ForeignKey("IngredientService.ingredient_category.category_id"))
...
class IngredientInventory(Base):
    ...
    ingredient_id = Column(Integer, ForeignKey("IngredientService.ingredient.ingredient_id"), primary_key=True)
